/**
 * Vercel Serverless Function: Google Maps Directions API プロキシ
 *
 * 本番環境では Vite dev proxy が無いため、この関数経由で Directions API を呼ぶ。
...
export default async function handler(req, res) {
  ...
  const targetUrl = new URL(GOOGLE_DIRECTIONS_URL)
