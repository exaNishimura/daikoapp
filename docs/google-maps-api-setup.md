...
### ステップ3: Directions API / Distance Matrix APIを有効化
1. 左メニューから「APIとサービス」→「ライブラリ」を選択
2. 検索バーで「Directions API」を検索し、有効にする
3. 同様に「Distance Matrix API」を検索し、有効にする（所要時間マップで使用）
...
4. 「Directions API」「Distance Matrix API」にチェックを入れる
5. 「保存」をクリック
